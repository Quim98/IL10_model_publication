# Script predicting pSTAT1 and pSTAT3 among single-chain dimeric variants of IL-10, given certain error in the initial conditions. These results are used in the prediction of dose-response curves.
...
df_bind = pd.read_csv('data/binding/IL10_data_param_ABC_SMC_IL10_RAp_ODE_scIL10.csv')

# Create dataset of simulations
num_sim = 12
cell_list = ["Haftl","BLaER1"]
variant_list = ["WT","MutSC1"]
STAT_list = ["pSTAT3"]
low_IL = 1e-11
high_IL = 1e-7
...
df_res.to_csv("results/fit_param/simulations_fit_IL10_RAp_ODE_scIL10.csv",index=False)
