...
import numpy as np
from src.models.IL10_RAp_ODE2 import model_function as model_function_IL10_RAp
import pandas as pd
...
df_fit_data = pd.read_csv(path_data+'/IL10/data/ABC_SMC/param_inference_IC_IL10_ODE_WT.csv') # Parameters to fit
