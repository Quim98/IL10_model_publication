...
df_fit_data = pd.read_csv(path_data+'/IL10/data/ABC_SMC/param_inference_IC_IL10_10DE.csv') # Parameters to fit
...
ABC_SMC_path = "pyABC_inference_mut.db"
conf95_interval = 1.75 #1.5 is to much since a lot of the population is out of bounds -> algorithm can't decrease the epsilon
pop_size_init = 750
pop_size_max = 1250
