...
#from src.models.IL10_MS1_seq import model_function
import pandas as pd
...
delta_0 = 5e-2
H = local_slopiness(delta_0, df_bind, df_sim_data, df_IC_data, df_EC50_AMP, num_IL_sim, num_cores, model_function, param_mut, param_depen)
