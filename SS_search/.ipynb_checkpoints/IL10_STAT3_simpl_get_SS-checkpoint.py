...
RA_expr = RA0-RA-(rho_2+2*rho_4+rho_5+rho_6+2*rho_8+rho_9+2*rho_10)/rho_t*ILM0
RB_expr = RB0-RB-(rho_3+2*rho_7+rho_5+rho_6+rho_8+2*rho_9+2*rho_10)/rho_t*ILM0
IL_expr = ILM0-IL10M-(rho_1+rho_2+rho_3+rho_4+rho_5+rho_6+rho_7+rho_8+rho_9+rho_10)/rho_t*ILM0

ILRA1RB1 = RA0-RA-(rho_2+2*rho_4+rho_6+2*rho_8+rho_9+2*rho_10)/rho_t*ILM0
ILRA1RA2RB1 = (RA0-RA-(rho_2+2*rho_4+rho_5+rho_6+rho_9+2*rho_10)/rho_t*ILM0)/2
ILRA1RB1RB2 = RA0-RA-(rho_2+2*rho_4+rho_5+rho_6+2*rho_8+2*rho_10)/rho_t*ILM0
ILRA1RA2RB1RB2 = (RA0-RA-(rho_2+2*rho_4+rho_5+rho_6+2*rho_8+rho_9)/rho_t*ILM0)/2
