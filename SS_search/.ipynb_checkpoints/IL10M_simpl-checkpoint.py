...
obj=writescripts.PrepareFilesNoneq(edgelist=graph_final,varGRF='IL10D',concvars=['RA','RB'],parlist=parlist,MTTfolder=MTTfolder,graphbasename=basename)
...
with open("rhos_dimer.pkl", "wb") as file:
