...
obj=writescripts.PrepareFilesNoneq(edgelist=graph_final,varGRF='IL10D',concvars=['IL10M','RA','RB','S3'],parlist=parlist,MTTfolder=MTTfolder,graphbasename=basename)# Gets all spanning trees for each node and gets the correpondant rho
...
with open("rhos_STAT3_simpl.pkl", "wb") as file:
