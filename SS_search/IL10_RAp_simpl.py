...
obj=writescripts.PrepareFilesNoneq(edgelist=graph_final,varGRF='IL10D',concvars=['IL10M','RA','RB','RAp'],parlist=parlist,MTTfolder=MTTfolder,graphbasename=basename)
...
with open("rhos_IL10_RAp_simpl.pkl", "wb") as file:
