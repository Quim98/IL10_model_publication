...
def model_function(PA):
    ...
    if PA["STAT_type"].values[0] == "pSTAT3":
        ...
        PA["Result"] = simulator['IL_RA1p_RB1'][-1]+simulator['IL_RA2p_RB2'][-1]+simulator['IL_RA1p_RA2_RB1'][-1]+simulator['IL_RA1p_RA2p_RB1'][-1]+simulator['IL_RA1_RA2p_RB2'][-1]+simulator['IL_RA1p_RA2p_RB2'][-1]+simulator['IL_RA1p_RB1_RB2'][-1]+simulator['IL_RA2p_RB1_RB2'][-1]+2*simulator['IL_RA1p_RA2p_RB1_RB2'][-1]
