# In this script we simualte the Receptor memory model, but assumming STAT1 can also be phophorylated in cis by Jak1 (dimeric IL-10)

import sys
sys.path.append('/users/lserrano/qmarti/PhD_code/IL10') # Add the directory containing the script to sys.path
import numpy as np
from src.models.extra_models.IL10_RAp_ODE_S1RA import model_function
import pandas as pd
...
df_res.to_csv("../results/fit_param/model_perturbations/simulations_fit_IL10_RAp_eIC_ODE_S1RA.csv",index=False)
