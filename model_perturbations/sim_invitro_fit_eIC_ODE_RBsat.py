# In this script we try to explain the signaling decay at high IL-10 concentrations through higher IL-10RB binding
...
df_res.to_csv("../results/fit_param/model_perturbations/simulations_fit_IL10_RAp_eIC_ODE_RBsat.csv",index=False)
