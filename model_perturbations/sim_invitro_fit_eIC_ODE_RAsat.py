# In this script we try to explain the signaling decay at high IL-10 concentrations through IL-10RA binding producing half-saturation

import sys
sys.path.append('/users/lserrano/qmarti/PhD_code/IL10') # Add the directory containing the script to sys.path
import numpy as np
from src.models.extra_models.IL10_RAp_ODE_RAsat import model_function
import pandas as pd
...
df_res.to_csv("../results/fit_param/model_perturbations/simulations_fit_IL10_RAp_eIC_ODE_RAsat.csv",index=False)
